...
<body>
    ...
    <div class="table-wrapper">
        <div class="table-title" style="padding-bottom: 15px; padding-left:50px;
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h2><b>Mapping of Experiments with Course Outcomes</b></h2>
                </div>
                <div class="col-sm-6">
                    <a href="#addEmployeeModal" class="btn btn-success" style:"padding-right:100px" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add</span></a>						
                </div>
            </div>
        </div>
            ...
            <thead>
              ...
              <%
                ...
                %>
                    ...
                    <td><%=resultSet.getString("CO1")%></td>
                    <td><%=resultSet.getString("CO2")%></td>
                    <td><%=resultSet.getString("CO3")%></td>
                    <td><%=resultSet.getString("CO4")%></td>
                    <td><%=resultSet.getString("CO5")%></td>
                    <td><%=resultSet.getString("CO6")%></td>
                </tr>
                    <%
                    }
                    connection.close();
   ...
   <!-- Add Modal HTML -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="./expc.jsp" method="post">
                ...
                <div class="modal-body">					
                      <div class="form-group">
                        ...
                        <label>CO1</label>
                        <input type="text" class="form-control" name="CO1">
                        <label>CO2</label>
                        <input type="text" class="form-control" name="CO2">
                        <label>CO3</label>
                        <input type="text" class="form-control" name="CO3">
                        <label>CO4</label>
                        <input type="text" class="form-control" name="CO4">
                        <label>CO5</label>
                        <input type="text" class="form-control" name="CO5">
                        <label>CO6</label>
                        <input type="text" class="form-control" name="CO6">
