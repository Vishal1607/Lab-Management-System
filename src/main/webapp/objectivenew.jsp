...
<body>
    ...
    <div class="table-wrapper">
        ...
        <form action="./objectivec.jsp" method="post">
			  <div class="mb-3">
			    <label for="exampleInputEmail1" class="form-label">Objective</label>
			    <input type="text" class="form-control" id="exampleInputEmail1" name="objective">
			  <button type="submit" class="btn btn-primary" style="background-color: green; width: 850px;">Submit</button>
			</form>
            ...
            <thead>
             ...
             <%
                ...
                %>
                    ...
                    %>
                    <tr>
                    <td style="width: 850px;"><%=resultSet.getString("objective")%></td>
                </tr>
                    <%
                    }
                    connection.close();
