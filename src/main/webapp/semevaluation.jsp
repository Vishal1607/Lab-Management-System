            ...
            <thead>
              ...
              <%
                ...
                %>
                    ...
                    <td><input type="number"  id="a" onclick="calc();"></td>
                    <td><input type="number"  id="b" onclick="calc();"></td>
                    <td><input type="number"  id="c" onclick="calc();"></td>
                    <td><input type="number"  id="d" onclick="calc();"></td>
   ...
   <!-- Add Modal HTML -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
      	...
      	<script src="js/website3.js"></script>
