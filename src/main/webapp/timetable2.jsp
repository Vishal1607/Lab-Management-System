...
<link rel="stylesheet" href="css/semform.css">
   ...
   <!-- Add Modal HTML -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="./timetable2c.jsp" method="post">
                ...
                <div class="modal-body">					
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subject1" placeholder="subject name" required>
                    </div>
                    <div class="form-group">
                        <label>Period 2</label>
                        <input type="text" class="form-control" name="subject2" placeholder="subject name" required>
                    </div>
                    <div class="form-group">
                        <label>Period 3</label>
                        <input type="text" class="form-control" name="subject3" placeholder="subject name" required>
                    </div>
                    <div class="form-group">
                        <label>Period 4</label>
                        <input type="text" class="form-control" name="subject4" placeholder="subject name" required>
                    </div>
                    <div class="form-group">
                        <label>Period 5</label>
                        <input type="text" class="form-control" name="subject5" placeholder="subject name" required>
                    </div>
                    <div class="form-group">
                        <label>Period 6</label>
                        <input type="text" class="form-control" name="subject6" placeholder="subject name" required>
                    </div>
